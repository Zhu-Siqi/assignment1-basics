...
from cs336_basics import model, train_modules
...
def run_linear(
    ...
    """
    linear_layer = model.CustomLinear(d_in, d_out)
...
def run_embedding(
    ...
    """
    embedding_layer = model.CustomEmbedding(
        vocab_size, d_model
    )
...
def run_rmsnorm(
    ...
    """
    rmsnorm_layer = model.CustomRMSNorm(d_model, eps)
...
def run_get_batch(
    ...
    """
    return train_modules.get_batch(dataset, batch_size, context_length, device)
...
def run_cross_entropy(
    ...
    """
    criterion = train_modules.CustomCrossEntropyLoss()
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    train_modules.gradient_clipping(parameters, max_l2_norm)
...
def get_adamw_cls() -> Any:
    ...
    """
    return train_modules.CustomAdamW
...
def run_get_lr_cosine_schedule(
    ...
    """
    return train_modules.get_lr(it, max_learning_rate, min_learning_rate, warmup_iters, cosine_cycle_iters)
...
def run_save_checkpoint(
    ...
    """
    train_modules.save_checkpoint(model, optimizer, iteration, out)
...
def run_load_checkpoint(
    ...
    """
    return train_modules.load_checkpoint(src, model, optimizer)
    ...
    Returns:
        tuple[dict[int, bytes], list[tuple[bytes, bytes]]]:
            ...
            merges:
                ...
                Merges are ordered by order of creation.
    """
    return tokenizer.run_train_bpe(
        input_path,
        vocab_size,
        special_tokens,
        **kwargs,
